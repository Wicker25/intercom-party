...
#ifndef __INTERCOM_PARTY_LOCATION_MANAGER_TEST_HPP__
#define __INTERCOM_PARTY_LOCATION_MANAGER_TEST_HPP__
...
#endif /* __INTERCOM_PARTY_LOCATION_MANAGER_TEST_HPP__ */